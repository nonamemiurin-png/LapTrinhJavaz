...
export default function ResearchDashboard() {
  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto flex flex-col gap-6 px-4 pb-16">
      ...
      <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl border border-white/20 shadow-xl rounded-3xl p-6">
        ...
        <form onSubmit={handleEvaluate} className="flex flex-col gap-4 lg:flex-row lg:items-end">
          ...
          <button 
            ...
            className="h-[50px] w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-medium rounded-xl px-6 shadow-lg shadow-indigo-500/30 transition-all disabled:opacity-50 flex items-center justify-center gap-2 lg:w-auto"
          >
